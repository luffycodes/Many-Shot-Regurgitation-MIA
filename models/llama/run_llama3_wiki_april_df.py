...
if __name__ == '__main__':
    ...
    book_name = "april_wiki_1k_min.csv"
    ...
    for index, row in result_df.iterrows():
        ...
        if args.gpt == 0:
            ...
            result_df.to_csv(f'april_wiki_1k_min/gpt3_1k_fixed_temp_dot{str(round(args.temp*10))}_splits_{str(n)}_{book_name}', index=False)
