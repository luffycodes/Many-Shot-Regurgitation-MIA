...
if __name__ == '__main__':
    ...
    for index, row in result_df.iterrows():
        ...
        if args.gpt == 0:
            ...
            result_df.to_csv(f'{book_name[:-4]}/gpt3_{str(num_words)}_fixed_temp_dot{str(round(args.temp*10))}_splits_{str(n)}_{book_name}', index=False)
